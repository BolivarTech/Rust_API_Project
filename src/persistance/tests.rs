mod answers_tests {
    ...
    #[sqlx::test]
    async fn create_answer_should_fail_with_malformed_uuid(pool: SqlitePool) -> Result<(), String> {
    ...
    #[sqlx::test]
    async fn create_answer_should_succeed(pool: SqlitePool) -> Result<(), String> {
    ...
    #[sqlx::test]
    async fn delete_answer_should_fail_with_malformed_uuid(pool: SqlitePool) -> Result<(), String> {
        let answer_doa = AnswersDaoImpl::new(pool);
    ...
    #[sqlx::test]
    async fn delete_answer_should_succeed(pool: SqlitePool) -> Result<(), String> {
        let question_doa = QuestionsDaoImpl::new(pool.clone());
        let answer_doa = AnswersDaoImpl::new(pool);
    ...
    #[sqlx::test]
    async fn get_answers_should_fail_with_malformed_uuid(pool: SqlitePool) -> Result<(), String> {
        let answer_doa = AnswersDaoImpl::new(pool);
    ...
    #[sqlx::test]
    async fn get_answers_should_fail_if_database_error_occurs(pool: SqlitePool) -> Result<(), String> {
        let answer_doa = AnswersDaoImpl::new(pool.clone());
    ...
    #[sqlx::test]
    async fn get_answers_should_succeed(pool: SqlitePool) -> Result<(), String> {
        let question_doa = QuestionsDaoImpl::new(pool.clone());
        let answer_doa = AnswersDaoImpl::new(pool);
...
mod questions_tests {
    ...
    #[sqlx::test]
    async fn create_question_should_succeed(pool: SqlitePool) -> Result<(), String> {
    ...
    #[sqlx::test]
    async fn delete_question_should_fail_with_malformed_uuid(pool: SqlitePool) -> Result<(), String> {
        let doa = QuestionsDaoImpl::new(pool);
    ...
    #[sqlx::test]
    async fn delete_question_should_succeed(pool: SqlitePool) -> Result<(), String> {
        let doa = QuestionsDaoImpl::new(pool);
    ...
    #[sqlx::test]
    async fn get_questions_should_succeed(pool: SqlitePool) -> Result<(), String> {
        let doa = QuestionsDaoImpl::new(pool);
